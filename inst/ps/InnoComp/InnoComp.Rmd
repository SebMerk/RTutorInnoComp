...
library(RTutor)
check.problem.set('InnoComp', ps.dir, ps.file, user.name=user.name, reset=FALSE)
...
#! addon__quiz__Tooltip


info("OECD data") # Run this line (Strg-Enter) to show info
...
info("read.dta() and the package foreign") # Run this line (Strg-Enter) to show info
...
info("mutate() and select()") # Run this line (Strg-Enter) to show info
...
```{r "1_1__2",fig.height=10, fig.width=12}
...
```{r "1_1__3",output='htmlwidget', widget='plotly'}
library(plotly)
ggplotly(g_share)
```
...
```{r "1_1__4",output='htmlwidget', widget='plotly'}
...
```{r "1_1__5",output='htmlwidget', widget='plotly'}
...
info("Patents") # Run this line (Strg-Enter) to show info
...
info("Herfindahl-Hirschman index (HHI)") # Run this line (Strg-Enter) to show info
...
info("dplyr: group_by() %>% summarise()") # Run this line (Strg-Enter) to show info
...
```{r "2__9",output='htmlwidget', widget='plotly'}
library(ggplot2)
...
```{r "2__17",output='htmlwidget', widget='plotly'}
...
info("Fixed Effects with with felm()") # Run this line (Strg-Enter) to show info
...
info("Variables of modellevel") # Run this line (Strg-Enter) to show info
...
info("Data Preparation: Demand Estimation") # Run this line (Strg-Enter) to show info
...
info("Notation issues") # Run this line (Strg-Enter) to show info
...
```{r "4_1___3",fig.width=12, fig.height=10}
...
```{r "4_1___4",optional=TRUE}
filter(equilibrium_data, firms==5, xi1==-14, xi5==-14)
```


#! addon__quiz__SymmetricFirms
...
```{r "4_1___12",fig.width=12, fig.height=10}
# fig3 = ggplot() + 
...
#! addon__quiz__Missing points

info("Explanation of the quiz answer above") # Run this line (Strg-Enter) to show info
...
```{r "4_1___15",output='htmlwidget', widget='plotly'}
library(plotly)
...
```{r "4_2__2___4499276",fig.width=12}
library(gridExtra)
